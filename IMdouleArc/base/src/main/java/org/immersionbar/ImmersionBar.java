...
public final class ImmersionBar implements ImmersionCallback {
    ...
    void setBar() {
        ...
        if (OSUtils.isMIUI6Later()) {
            //修改miui状态栏字体颜色
            setMIUIBarDark(mWindow, Constants.IMMERSION_MIUI_STATUS_BAR_DARK, mBarParams.statusBarDarkFont);
            //修改miui导航栏图标为黑色
            if (mBarParams.navigationBarEnable) {
                setMIUIBarDark(mWindow, Constants.IMMERSION_MIUI_NAVIGATION_BAR_DARK, mBarParams.navigationBarDarkIcon);
            }
        }
        // 修改Flyme OS状态栏字体颜色
