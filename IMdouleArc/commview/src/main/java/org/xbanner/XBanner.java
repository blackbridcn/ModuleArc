...
import org.xbanner.transformers.BasePageTransformer;
import org.xbanner.transformers.Transformer;
import org.xbanner.utils.XBannerUtils;
...
public class XBanner extends RelativeLayout implements XBannerViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
     ...
     * 资源集合
     */
    private List<? extends BannerData> mDatas;
    ...
    private void initCustomAttrs(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.CommViewXBanner);
        if (typedArray != null) {
            mIsAutoPlay = typedArray.getBoolean(R.styleable.CommViewXBanner_isAutoPlay, true);
            mIsHandLoop = typedArray.getBoolean(R.styleable.CommViewXBanner_isHandLoop, false);
            mIsTipsMarquee = typedArray.getBoolean(R.styleable.CommViewXBanner_isTipsMarquee, false);
            mAutoPalyTime = typedArray.getInteger(R.styleable.CommViewXBanner_AutoPlayTime, 5000);
            mPointsIsVisible = typedArray.getBoolean(R.styleable.CommViewXBanner_pointsVisibility, true);
            mPointPosition = typedArray.getInt(R.styleable.CommViewXBanner_pointsPosition, CENTER);
            mPointContainerLeftRightPadding = typedArray.getDimensionPixelSize(R.styleable.CommViewXBanner_pointContainerLeftRightPadding, mPointContainerLeftRightPadding);
            mPointLeftRightPading = typedArray.getDimensionPixelSize(R.styleable.CommViewXBanner_pointLeftRightPadding, mPointLeftRightPading);
            mPointTopBottomPading = typedArray.getDimensionPixelSize(R.styleable.CommViewXBanner_pointTopBottomPadding, mPointTopBottomPading);
            mPointContainerPosition = typedArray.getInt(R.styleable.CommViewXBanner_pointContainerPosition, BOTTOM);
            mPointContainerBackgroundDrawable = typedArray.getDrawable(R.styleable.CommViewXBanner_pointsContainerBackground);
          //  mPointNoraml = typedArray.getResourceId(R.styleable.CommViewXBanner_pointNormal, R.drawable.comm_view_xbanner_shape_point_normal);
           // mPointSelected = typedArray.getResourceId(R.styleable.CommViewXBanner_pointSelect, R.drawable.comm_view_xbanner_shape_point_select);
            mPointNoraml = typedArray.getResourceId(R.styleable.CommViewXBanner_pointNormal, R.drawable.comm_view_xbanner_shape_rectangle_normal);
            mPointSelected = typedArray.getResourceId(R.styleable.CommViewXBanner_pointSelect, R.drawable.comm_view_xbanner_shape_rectangle_select);
            mTipTextColor = typedArray.getColor(R.styleable.CommViewXBanner_tipTextColor, mTipTextColor);
            mTipTextSize = typedArray.getDimensionPixelSize(R.styleable.CommViewXBanner_tipTextSize, mTipTextSize);
            mIsNumberIndicator = typedArray.getBoolean(R.styleable.CommViewXBanner_isShowNumberIndicator, mIsNumberIndicator);
            mNumberIndicatorBackground = typedArray.getDrawable(R.styleable.CommViewXBanner_numberIndicatorBacgroud);
            mIsShowIndicatorOnlyOne = typedArray.getBoolean(R.styleable.CommViewXBanner_isShowIndicatorOnlyOne, mIsShowIndicatorOnlyOne);
            mPageChangeDuration = typedArray.getInt(R.styleable.CommViewXBanner_pageChangeDuration, mPageChangeDuration);
            mPlaceholderDrawableResId = typedArray.getResourceId(R.styleable.CommViewXBanner_placeholderDrawable, mPlaceholderDrawableResId);
            mIsClipChildrenMode = typedArray.getBoolean(R.styleable.CommViewXBanner_isClipChildrenMode, false);
            mClipChildrenLeftRightMargin = typedArray.getDimensionPixelSize(R.styleable.CommViewXBanner_clipChildrenLeftRightMargin, mClipChildrenLeftRightMargin);
            mClipChildrenTopBottomMargin = typedArray.getDimensionPixelSize(R.styleable.CommViewXBanner_clipChildrenTopBottomMargin, mClipChildrenTopBottomMargin);
            mViewPagerMargin = typedArray.getDimensionPixelSize(R.styleable.CommViewXBanner_viewpagerMargin, mViewPagerMargin);
            mIsClipChildrenModeLessThree = typedArray.getBoolean(R.styleable.CommViewXBanner_isClipChildrenModeLessThree, false);
            mIsShowTips = typedArray.getBoolean(R.styleable.CommViewXBanner_isShowTips, false);
            mBannerBottomMargin = typedArray.getDimensionPixelSize(R.styleable.CommViewXBanner_bannerBottomMargin, mBannerBottomMargin);
            mViewPagerClipChildren = typedArray.getBoolean(R.styleable.CommViewXBanner_viewPagerClipChildren, false);
            int scaleTypeIndex = typedArray.getInt(R.styleable.CommViewXBanner_xscaleType, -1);
     ...
     */
    @Deprecated
    private void setData(@NonNull List<View> views, @NonNull List<? extends BannerData> data, List<String> tips) {
     ...
     */
    @Deprecated
    public void setData(@LayoutRes int layoutResId, @NonNull List<? extends BannerData> models, List<String> tips) {
     ...
     */
    @Deprecated
    public void setData(@NonNull List<? extends BannerData> models, List<String> tips) {
        setData(R.layout.comm_view_xbanner_item_image, models, tips);
    }
     ...
     * 设置bannner数据
     */
    private void setBannerData(@NonNull List<View> views, @NonNull List<? extends BannerData> data) {
    ...
    public void setBannerData(@LayoutRes int layoutResId, @NonNull List<? extends BannerData> models) {
        mViews = new ArrayList<>();
        if (models == null) {
            models = new ArrayList<>();
        }
    ...
    public void setBannerData(@NonNull List<? extends BannerData> models) {
        setBannerData(R.layout.comm_view_xbanner_item_image, models);
       // setBannerData(R.layout.comm_view_layout_fresco_imageview, models);
    }
    ...
    private void initViewPager() {
        ...
        if (mIsClipChildrenMode) {
            ...
            setOnTouchListener((v, event) -> mViewPager.dispatchTouchEvent(event));
        }
    ...
    public void onPageScrolled(int position, float positionOffset,
        ...
        if (mTipTv != null && mDatas != null && mDatas.size() != 0 && mDatas.get(0) instanceof BannerData) {
            if (positionOffset > 0.5) {
                mTipTv.setText(((BannerData) mDatas.get((position + 1) % mDatas.size())).getXBannerTitle());
                mTipTv.setAlpha(positionOffset);
            } else {
                mTipTv.setText(((BannerData) mDatas.get(position % mDatas.size())).getXBannerTitle());
            ...
            if (mOnItemClickListener != null && mDatas.size() != 0) {
                view.setOnClickListener(new OnDoubleClickListener() {
                    ...
                    public void onNoDoubleClick(View v) {
                        mOnItemClickListener.onItemClick(mDatas.get(realPosition), v, realPosition);
                    }
                });
            }

            if (null != mAdapter && mDatas.size() != 0) {
                mAdapter.loadBanner(mDatas.get(realPosition), view, realPosition);
            }
    ...
    private void switchToPoint(int currentPoint) {
        ...
        if (mTipTv != null && mDatas != null && mDatas.size() != 0 && mDatas.get(0) instanceof BannerData) {
            mTipTv.setText(((BannerData) mDatas.get(currentPoint)).getXBannerTitle());
        } else if (mTipTv != null && mTipData != null && !mTipData.isEmpty()) {
    ...
    public interface OnItemClickListener {
        void onItemClick(BannerData model, View view, int position);
    }

    public interface XBannerAdapter {
        void loadBanner(BannerData model, View view, int position);
    }
}
