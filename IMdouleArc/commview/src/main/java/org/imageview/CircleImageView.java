...
public class CircleImageView extends AppCompatImageView {
	...
	public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.CommViewCircleImageView, defStyle, 0);

		mBorderWidth = a.getDimensionPixelSize(
				R.styleable.CommViewCircleImageView_civ_border_width,
				DEFAULT_BORDER_WIDTH);
		mBorderColor = a.getColor(R.styleable.CommViewCircleImageView_civ_border_color,
				DEFAULT_BORDER_COLOR);
		mBorderOverlay = a.getBoolean(
				R.styleable.CommViewCircleImageView_civ_border_overlay,
				DEFAULT_BORDER_OVERLAY);
		mFillColor = a.getColor(R.styleable.CommViewCircleImageView_civ_fill_color,
				DEFAULT_FILL_COLOR);
