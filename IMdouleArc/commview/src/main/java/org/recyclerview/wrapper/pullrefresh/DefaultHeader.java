package org.recyclerview.wrapper.pullrefresh;
...
public class DefaultHeader extends BaseIndicator {
    ...
    public View createView(LayoutInflater inflater, ViewGroup parent) {
        //ViewGroup v = (ViewGroup) inflater.inflate(R.layout.comm_view_prj_ptr_header_default, parent, true);
        ViewGroup v = (ViewGroup) inflater.inflate(R.layout.comm_view_header_default_layout, parent, true);
