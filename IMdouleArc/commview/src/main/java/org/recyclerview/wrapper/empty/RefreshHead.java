...
/**
 * File: RefreshHead.java
 * Author: yuzhuzhang
 * Create: 2020-02-25 21:06
 * Description: TODO
 * -----------------------------------------------------------------
 * 2020-02-25 : Create RefreshHead.java (yuzhuzhang);
 * -----------------------------------------------------------------
 */
public class RefreshHead extends LinearLayout {
  ...
  /*      refreshLimitHeight = getScreenHeight() / 6;
        ...
        //一开始设置高度为0 不显示刷新布局
        addView(refreshContentView, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 0));
    ...
    public void startRefreshingAnimation() {
        ...
        animator.addUpdateListener(animation -> imageRefreshing.setRotation((Float) animation.getAnimatedValue()));
        animator.start();
/*
...
//                    imageRefreshing.clearAnimation();
    ...
    private void rotationAnimator(float rotation) {
        ...
        animator.addUpdateListener(animation -> imageArrow.setRotation((Float) animation.getAnimatedValue()));
        animator.start();
    }
