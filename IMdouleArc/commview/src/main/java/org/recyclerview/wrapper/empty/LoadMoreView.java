 ...
 * Description: TODO
 * -----------------------------------------------------------------
 * 2020-02-25 : Create LoadMoreView.java (yuzhuzhang);
 * -----------------------------------------------------------------
 */
public class LoadMoreView extends LinearLayout {
    private ImageView imageLoadMore; //加载更多的图片
    ...
    /*    View loadMoreContentView =  LayoutInflater.from(getContext()).inflate(
        ...
        imageLoadMore = (ImageView) loadMoreContentView.findViewById(R.id.load_more_icon_iv);
