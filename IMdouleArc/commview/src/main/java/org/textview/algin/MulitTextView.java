...
/**
 * File: MulitTextView.java
 * Author: yuzhuzhang
 * Create: 2020/3/20 5:40 PM
 * Description: TODO 自定义分散对齐的TextView(中英文排版效果) 非中文单词换行截断
 * -----------------------------------------------------------------
 * 2020/3/20 : Create MulitTextView.java (yuzhuzhang);
 * -----------------------------------------------------------------
 */
public class MulitTextView  extends androidx.appcompat.widget.AppCompatTextView {

    private static final String TAG = MulitTextView.class.getSimpleName();
    ...
    public MulitTextView(Context context) {
        this(context, null);
    }

    public MulitTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MulitTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public MulitTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
